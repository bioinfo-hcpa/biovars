...
biovars_plot_list<- function(current_dir, saving_path, df, frequency=0.01, map=FALSE,info=FALSE){
  ...
  if(map){
    ...
    plot_list <- get_all_plots(pops_vars, pop_colors,map,info)
  ...
  info_pop_names=names(pops_vars)
  if(info){
    info_pop <- get_all_plots(pops_vars, pop_colors,map,info)
    return(info_pop)
    }
}

biovars_plot_list('/home/lola/Documents/BIOVARS/biovars/biovars/R_plotting_scripts/', 'rplot_world_view',data,map=TRUE,info=FALSE)
pop_info=biovars_plot_list('/home/lola/Documents/BIOVARS/biovars/biovars/R_plotting_scripts/', 'aqui2.pdf',data,map=FALSE,info=TRUE)
